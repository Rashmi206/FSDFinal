...
export class EditTaskComponent implements OnInit {
  ...
  selectedTask: any;
  task: Task[];
  constructor(private route: ActivatedRoute, private fb: FormBuilder, public dialog: MatDialog, private userService: UserService, private projectService: ProjectService, private taskService: TaskService, public datepipe: DatePipe, public router: Router) { }
